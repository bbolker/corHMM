...
dev.corhmm_rtmb <- function(p, phy, liks, Q, rate, root.p, rate.cat, order.test, lewis.asc.bias, set.fog=FALSE, fog.vec, build = FALSE) {
  ...
  ## BMB: may have to use a different expm() (see pruning fn)
